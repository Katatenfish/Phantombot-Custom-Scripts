    ...
    $.bind('discordChannelCommand', function(event) {
        ...
        if (command.equalsIgnoreCase('rules')) {
            $.discordAPI.sendMessageEmbed(channelName, new Packages.sx.blah.discord.util.EmbedBuilder()
                ...
                .withThumbnail('http://i.imgur.com/images/welcome.png')
            ...
            setTimeout(function(){
                $.discordAPI.sendMessageEmbed(channelName, new Packages.sx.blah.discord.util.EmbedBuilder()
                    .withColor(164, 65, 65)
                    .withThumbnail('http://i.imgur.com/images/disclaimer.png')
            ...
            setTimeout(function(){
                $.discordAPI.sendMessageEmbed(channelName, new Packages.sx.blah.discord.util.EmbedBuilder()
                    .withColor(67, 164, 65)
                    .withThumbnail('http://i.imgur.com/images/roles.png')
            ...
            setTimeout(function(){
                $.discordAPI.sendMessageEmbed(channelName, new Packages.sx.blah.discord.util.EmbedBuilder()
                    ...
                    .withThumbnail('http://i.imgur.com/images/twitch.png')
            ...
            setTimeout(function(){
                $.discordAPI.sendMessageEmbed(channelName, new Packages.sx.blah.discord.util.EmbedBuilder()
                    ...
                    .withThumbnail('http://i.imgur.com/images/twitter.png')
